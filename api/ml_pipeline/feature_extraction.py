        ...
        try:
            ...
            for detection in detections.detections:
                try:
                    ...
                    logger.info(
                        f"🧠 Extracted features for cat {detection.cat_uuid}: "
                    ...
                    logger.warning(
                        f"Failed to extract features for detection {detection.cat_uuid}: {e}"
                    )
            ...
            logger.info(
                f"🎯 Feature extraction completed for {len(updated_detections)} cats with ResNet50 embeddings"
            )
